...
public enum Tier {
    ONE(1, new AnimalInfo[] { Animals.Mouse, Animals.Shrimp, Animals.Chipmunk, Animals.KangarooRat }, 12, 3.768, 0, 425,
            225, 14),
    TWO(2, new AnimalInfo[] { Animals.Rabbit, Animals.Pigeon, Animals.Trout, Animals.ArcticHare,
            Animals.DesertChipmunk }, 12, 3.5, 50, 435, 230, 14),
    THREE(3, new AnimalInfo[] { Animals.Mole, Animals.Chicken, Animals.Crab, Animals.Meerkat }, 16,
            3.4, 150, 435, 230, 19),
    FOUR(4, new AnimalInfo[] { Animals.Pig, Animals.Woodpecker, Animals.Seal, Animals.SeaHorse, Animals.Armadillo }, 20,
            3.23, 500, 445, 235, 22),
    FIVE(5, new AnimalInfo[] { Animals.Deer, Animals.Squid, Animals.Flamingo, Animals.Reindeer, Animals.Gazelle,
            Animals.BulletAnt }, 20,
            3.05, 1000, 445, 235, 22),
    SIX(6, new AnimalInfo[] { Animals.Fox, Animals.Hedgehog, Animals.Peacock, Animals.HoneyBee, Animals.JellyFish,
            Animals.ArcticFox,
            Animals.FennecFox }, 20, 2.80, 2000, 470, 235, 22),
    SEVEN(7, new AnimalInfo[] { Animals.Zebra, Animals.Donkey, Animals.Macaw, Animals.Turtle, Animals.Muskox,
            Animals.Warthog }, 20, 2.70, 4000, 490, 235, 22),
    EIGHT(8, new AnimalInfo[] { Animals.Cobra, Animals.Giraffe, Animals.Stingray, Animals.Walrus, Animals.SnowyOwl,
            Animals.Camel }, 20, 2.60, 8000, 490, 235, 23),
    NINE(9, new AnimalInfo[] { Animals.Cheetah, Animals.Gorilla, Animals.Toucan, Animals.SnowLeopard,
            Animals.PufferFish, Animals.RattleSnake }, 20, 2.50, 16000, 515, 235, 22),
    TEN(10, new AnimalInfo[] { Animals.Bear, Animals.Tiger, Animals.SwordFish, Animals.Pelican, Animals.Wolf,
            Animals.GobiBear, Animals.Hyena }, 20, 2.35, 32000, 530, 235, 22),
    ELEVEN(11,
    ...
    FIFTEEN(15,
            ...
            new AnimalInfo[] { Animals.BigFoot, Animals.Snowman }, 43, 1.9, 1000000, 645, 265, 46),
    SIXTEEN(16,
            new AnimalInfo[] { Animals.DinoMonster, Animals.LandMonster, Animals.SeaMonster, Animals.GiantScorpion,
                    Animals.IceMonster },
            44, 1.8, 5000000, 675, 275, 52),
    SEVENTEEN(17, new AnimalInfo[] { Animals.BlackDragon, Animals.SandStorm, Animals.DragonFire, Animals.KingDragon },
